...
\begin{frame}[shrink=2]{Fair and Real Bandwidth Ratios for a Flow}
\begin{columns}[T,onlytextwidth]
...
box/.style={draw=MethodColor,rounded corners,fill=CardBg,text width=6.3cm,align=left,inner xsep=7pt,inner ysep=5pt,font=\fontsize{8.5}{10}\selectfont},
...
\end{itemize}
\vspace{0.2cm}
\SmallNote{Original evaluation parameters: $High_{th}=1.05$, $Low_{th}=0.7$, $EP=2$ s.}
\end{columns}
\end{frame}
