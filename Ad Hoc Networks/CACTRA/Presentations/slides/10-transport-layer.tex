\begin{frame}[shrink=5]{Transport Layer: TCP over Multi-Hop Wireless}

\KeyPoint{TCP's sending rate is approximately $cwnd/RTT$ and is paced by returning acknowledgements.}
